...
//Задания для Цикла for. Прямой Диапазон:
//Напишите цикл for, который выводит числа от 1 до 5.
    ...
    //Обратный Диапазон: Создайте цикл for, который выводит числа от 5 до 1.
    for (i in 5 downTo 1) {
        println(i)
    }
    ...
    //С Шагом (step): Используйте цикл for с шагом 2 для вывода чисел от 1 до 9.
    for (i in 1..9 step 2) {
        println(i)
    }
    ...
    //Использование До (until): Используйте цикл for и until, чтобы вывести числа из диапазона 1-9 (9 не включается).
    for (i in 1 until 9) {
        println(i)
    }
    ...
    //Задания для Цикла while. Цикл while: Создайте цикл while, который выводит квадраты чисел от 1 до 5.
    var i = 1
    while (i <= 5) {
        val s = (i * i++)
        println(s)
    ...
    //Цикл do...while:Используйте цикл do...while, чтобы вывести числа от 5 до 1.
    var e = 5
    do{
        println(--e)
    } while(e > 1)
    ...
    //Задания для Прерывания и Пропуска Итерации Использование break:Напишите цикл for от 1 до 10 и используйте break, чтобы выйти из цикла при достижении 6.
    for(i in 1..10){
        if (i == 6)break
        println(i)
    }
    ...
    //Использование continue:В цикле for от 1 до 10 используйте continue, чтобы пропустить четные числа.
    for(i in 1..10){
        if (i % 2 == 1)continue
        println(i)
    }
